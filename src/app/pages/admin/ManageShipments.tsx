...
// import { Search, Edit, MapPin, Bell, Trash2 } from "lucide-react"; // Added Trash2
...
//         updates.current_location = editForm.current_location;
...
//                     className="p-2 bg-red-50 text-red-600 rounded-md hover:bg-red-600 hover:text-white transition-colors border border-red-100"
...
// import { supabase } from "../../../lib/supabase";
// import { toast } from "sonner";
// import { Search, Edit, MapPin, Bell, Trash2 } from "lucide-react";
...
//   // Updated state to include receiver and package details
//   const [editForm, setEditForm] = useState({
//     status: "",
//     current_location: "",
//     notes: "",
...
//       // Logic for notifications remains tied to status and location changes
...
//         );
//         await sendNotification(
//           editForm.receiver_email || shipment.receiver_email,
//           "Status Updated",
//           `Tracking ${shipment.tracking_number} status: ${editForm.status.toUpperCase()}`,
//         );
//       }
...
//                 <button
//                   onClick={() => handleDeleteShipment(shipment.id)}
//                   className="p-2 bg-red-50 text-red-600 rounded-md border border-red-100"
//                 >
//                   <Trash2 className="w-5 h-5" />
//                 </button>
//               </div>
